...
import net.reghours.filters.filter_beans.GZipServletResponseWrapper;

/**
 *
 * @author Benjamin Adam Nagy
 */
@WebFilter(filterName = "ResponseCompressionFilter", 
        urlPatterns = { "*.js", "*.jsp", "*.css", "*.html"})
public class ResponseCompressionFilter implements Filter {
    ...
    public String toString() {
        ...
        StringBuilder sb = new StringBuilder("ResponseCompressionFilter(");
